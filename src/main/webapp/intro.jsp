             ...
             <div style="font-size: medium; margin-top: 10px;">
                 ...
                 <ol class="decimal-list">
                     ...
                     <li>
                         ...
                         conditions.
                     <li>
                         Corridor networks including reduced lake-level scenarios that are weighted by proximity to
                         existing <i>Phragmites</i> to show likely invasion pathways.
                     </li>
                 </ol>
                 <p>Please see below for a depiction of the various features.</p>
             </div>
         </div>
